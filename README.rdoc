...
Mac OSX users will also need the {Growl}[http://growl.info/] notification system.
{Greasemonkey}[https://addons.mozilla.org/en-US/firefox/addon/748] is only required for userscript support.
...
script which uses Callout. This script works on {Digg spy}[http://digg.com/spy] and notifies the
